            ...
            <div className="px-4 pb-6">
              <div className="flex flex-col items-center gap-6">
                <div className="text-center">
                  <div className="text-foreground mb-2 font-mono text-3xl font-bold">{fontSize}px</div>
                  <div className="text-muted-foreground text-sm">Current font size</div>
                </div>
                ...
                <div className="w-full max-w-xs">
                  ...
                  <div className="bg-muted h-2 w-full rounded-full">
                    <div className="bg-primary h-2 rounded-full transition-all duration-300" style={{ width: `${((fontSize - 12) / (24 - 12)) * 100}%` }} />
                  </div>
                </div>
              </div>
            </div>
