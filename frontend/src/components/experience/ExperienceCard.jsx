          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              ...
              {experience.website && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href={experience.website} target="_blank" rel="noopener noreferrer" className="size-4 text-neutral-500">
                      <Website />
                    </a>
                  </TooltipTrigger>
              ...
              {experience.x && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href={experience.x} target="_blank" rel="noopener noreferrer" className="size-4 text-neutral-500">
                      <X />
                    </a>
                  </TooltipTrigger>
              ...
              {experience.linkedin && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href={experience.linkedin} target="_blank" rel="noopener noreferrer" className="size-4 text-neutral-500">
                      <LinkedIn />
                    </a>
                  </TooltipTrigger>
              ...
              {experience.github && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href={experience.github} target="_blank" rel="noopener noreferrer" className="size-4 text-neutral-500">
                      <Github />
                    </a>
                  </TooltipTrigger>
