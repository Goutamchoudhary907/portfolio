...
export const devices = [
  { name: 'Apple MacBook Pro 16"in M4 48GB 512GB', icon: <Laptop className="size-4" /> },
  { name: 'LG Ultragear 27GN650 (27 inch, 68.5 cm)', icon: <Monitor className="size-4" /> },
  { name: 'Magic Keyboard', icon: <Keyboard className="size-4" /> },
  { name: 'Logitech MX Master 3S Mouse', icon: <Mouse className="size-4" /> },
  { name: 'Crossbeats Roar 2.0 (Special Addition)', icon: <Headphones className="size-4" /> },
  { name: 'Samsung S23 (256 GB)', icon: <Phone className="size-4" /> },
];

export const webExtensions = [
  { name: 'Unhook', href: 'https://unhook.app/' },
  { name: 'uBlock Origin', href: 'https://ublockorigin.com/' },
  { name: 'React Developer Tools', href: 'https://chromewebstore.google.com/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi?hl=en' },
  ...
  { name: 'ColorZilla', href: 'https://chromewebstore.google.com/detail/colorzilla/bhlhnicpbhignbdhedgjhgdocnmhomnp?hl=en' },
];
